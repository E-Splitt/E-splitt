...
import { Users, Plus, X, Check, Edit2, Trash2, Share2 } from 'lucide-react';

const GroupSelector = ({ groups, currentGroup, onSelectGroup, onCreateGroup, onEditGroup, onDeleteGroup, onShareGroup }) => {
